...
export const WatchList = (props) => {
    return (
        <div>
            ...
            <MoviesListFilters />
            {props.movies.length ===0 ? <p>No movies yet- Add movies to your watching list from homepage</p>
...
const mapStateToProps = (state) => {
    return {
        movies: getVisibleMovies(getWatchListMovies(state.movies), state.filters)
    };
};
